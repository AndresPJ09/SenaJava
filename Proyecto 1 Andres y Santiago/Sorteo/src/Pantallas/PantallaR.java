...
public class PantallaR extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Verificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 560, -1, -1));

        fondo.setForeground(new java.awt.Color(255, 255, 255));
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/HD-wallpaper-edge-gold-black-edge-goldblack.jpg"))); // NOI18N

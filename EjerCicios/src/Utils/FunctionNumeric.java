...
public Double InputNumericRangeScannerPositivo(String mensaje) {
        do {            
            InputNumeric(mensaje,1);
...
public Double InputNumericRangeScannerNegativo(String mensaje) {
        do {            
            InputNumeric(mensaje,1);
        } while (this.getNumero() >= 0);
 ...
 public int InputNumericRangeScannerEntero(String mensaje, Double min, Double max) {
        do {            
            InputNumeric(mensaje,1);
...
public int InputNumericRangeScannerPositivoEntero(String mensaje) {
        do {            
            InputNumeric(mensaje,1);
...
public int InputNumericRangeScannerNegativoEntero(String mensaje) {
        do {            
            InputNumeric(mensaje,1);
        } while (this.getEntero()>= 0);
